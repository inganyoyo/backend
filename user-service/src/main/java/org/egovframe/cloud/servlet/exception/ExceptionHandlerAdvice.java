 ...
 *
 * <p>모든 컨트롤러에 적용되는 컨트롤러 어드바이스 클래스 예외 처리 (@ExceptionHandler), 바인딩 설정(@InitBinder), 모델
 * 객체(@ModelAttributes)
 *
...
public class ExceptionHandlerAdvice {
  ...
  protected ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(
    ...
    final ErrorResponse response =
        ErrorResponse.of(ErrorCode.INVALID_INPUT_VALUE, e.getBindingResult(), messageSource);
  ...
  protected ResponseEntity<ErrorResponse> handleUnprocessableEntityException(
  ...
  protected ResponseEntity<ErrorResponse> handleBusinessMessageException(
